...
class ProgramDatabase:
    ...
    def add(
        ...
        Args:
            ...
            defer_maintenance: When true, skip archive / best / migration follow-up
                work so callers can run it later off the insert hot path.
    ...
    def run_post_add_maintenance(
        ...
        """Run deferred maintenance for a program that was already inserted."""
        self.run_post_add_maintenance_batch(
            [program],
            verbose=verbose,
    ...
    def run_post_add_maintenance_batch(
        ...
        """Run deferred maintenance for already inserted programs in one batch."""
        if not programs:
            return
