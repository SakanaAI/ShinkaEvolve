...
- Added EVOLVE-BLOCK marker validation for block-comment languages (Wolfram, Markdown) in `shinka.edit.marker_validation`, catching the common LLM failure mode where both markers get smuggled into a single comment block.
