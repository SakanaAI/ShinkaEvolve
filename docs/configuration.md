...
| `inspiration_distance_metric` | `str` | `'cosine'` | Distance metric used to select the most distant crossover inspiration from the parent embedding. Falls back to random selection when embeddings are unavailable. |
